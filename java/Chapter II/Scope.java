...
Explanation:
    ...
    ScopeExample class defines a class-level variable classVar.
    ...
    In the main method, we create an instance of ScopeExample class and demonstrate accessing the class-level variable and invoking the methods.
